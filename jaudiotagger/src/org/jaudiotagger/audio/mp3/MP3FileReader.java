...
public class MP3FileReader extends AudioFileReader
{
    ...
    public AudioFile read(HttpFile f) throws IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException
    {
        MP3File mp3File = new MP3File(f, MP3File.LOAD_IDV1TAG, true);
        return mp3File;
    }
