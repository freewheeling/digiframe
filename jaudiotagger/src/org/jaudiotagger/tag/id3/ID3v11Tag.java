...
public class ID3v11Tag extends ID3v1Tag
{
    ...
    public ID3v11Tag(HttpFile file, String loggingFilename) throws TagNotFoundException, IOException
    {
        setLoggingFilename(loggingFilename);
        //FileChannel fc;
        ByteBuffer byteBuffer = ByteBuffer.allocate(TAG_LENGTH);
        ...
        //fc = file.getChannel();
        file.position(file.length() - TAG_LENGTH);
    ...
    /*
    public ID3v11Tag(HttpFile file) throws TagNotFoundException, IOException
    {
        //FileChannel fc;
        ByteBuffer byteBuffer = ByteBuffer.allocate(TAG_LENGTH);
