...
import com.hypermatix.digiframe.common.PlaybackActivity;
import android.app.Application;

public class DigiFrameApplication extends Application {

    @Override
    public void onCreate() {
        super.onCreate();
        PlaybackActivity.helperFactory = new HelperFactory();
    }
}
