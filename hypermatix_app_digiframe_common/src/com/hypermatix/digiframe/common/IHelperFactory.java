...
public interface IHelperFactory {
	public PlaybackHelper createForActivity(PlaybackHelperCallback callback, Activity activity, long slideshow);
	public PlaybackHelper createForService(PlaybackHelperCallback callback, Service service);
}
